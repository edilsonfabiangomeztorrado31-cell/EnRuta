...
public class ConveyorMenuView extends AppCompatActivity implements MenuContract.MenuView {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.conveyor_background_view_menu);
    ...
    public void cargarFragment(Fragment fragment) {
        getSupportFragmentManager().beginTransaction()
                .replace(R.id.fragment_container_conveyor, fragment)
                .addToBackStack(null)
                .commit();
    }
